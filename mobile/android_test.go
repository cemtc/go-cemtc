...
public class AndroidTest extends InstrumentationTestCase {
	...
	// signatures too. Regression test for elementalcore issue #14599.
...
func TestAndroid(t *testing.T) {
	...
	gobind := exec.Command("gomobile", "bind", "-javapkg", "org.ethereum", "github.com/Elemental-core/elementalcore/mobile")
