...
var (
	...
	authorsFileHeader = "# This is the official list of elementalcore authors for copyright purposes.\n\n"
)

// this template generates the license comment.
// its input is an info structure.
var licenseT = template.Must(template.New("").Parse(`
// Copyright {{.Year}} The elementalcore Authors
...
func (i info) Whole(startOfSentence bool) string {
	if i.gpl() {
		return "elementalcore"
	}
	if startOfSentence {
		return "The elementalcore library"
	}
	return "the elementalcore library"
}
