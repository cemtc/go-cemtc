...
import (
	...
	"github.com/Elemental-core/elementalcore/internal/build"
)
...
func doInstall(cmdline []string) {
	...
	if !strings.Contains(runtime.Version(), "devel") {
		...
		if minor < 7 {
			...
			log.Println("elementalcore requires at least Go version 1.7 and cannot")
...
type debMetadata struct {
	...
	// elementalcore version being built. Note that this
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/Elemental-core/elementalcore/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "--target", "ios", "--tags", "ios", "-v", "github.com/Elemental-core/elementalcore/mobile")
