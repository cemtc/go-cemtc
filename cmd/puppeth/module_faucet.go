...
RUN \
  apk add --update git go make gcc musl-dev ca-certificates linux-headers                             && \
	...
	(cd $GOPATH/src/github.com/ethereum && git clone --depth=1 https://github.com/Elemental-core/elementalcore) && \
  go build -v github.com/Elemental-core/elementalcore/cmd/faucet                                              && \
