// Copyright 2017 The elementalcore Authors
...
import (
	...
	"github.com/Elemental-core/elementalcore/ethclient"
...
func (f *faucet) apiHandler(conn *websocket.Conn) {
	...
	for {
		...
		default:
			err = errors.New("Something funky happened, please open an issue at https://github.com/Elemental-core/elementalcore/issues")
		}
		if err != nil {
			if err = sendError(conn, err); err != nil {
