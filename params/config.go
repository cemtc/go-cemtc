...
var (
	...
	DposChainConfig = &ChainConfig{
		...
		Dpos: &DposConfig{[]common.Address{
			common.HexToAddress("0xe72e7af8ad3716dd6ae2b3eca3f5ef567c3a64d2"),
			common.HexToAddress("0x74ea6fbbb8c4bfd566a77c6b5188125ac0f2fe14"),
			common.HexToAddress("0x6286b543d78ea89d50b36f694f769fbaa1dd8989"),
		}},
	}
	// GenesisAlloc specifies the initial state that is part of the genesis block.

	Alloc = map[string]string{
		"0xe72e7af8ad3716dd6ae2b3eca3f5ef567c3a64d2": "82500000000000000000000000", // 定义时指定的初始key/value, 后面可以继续添加
		"0x74ea6fbbb8c4bfd566a77c6b5188125ac0f2fe14": "10000000000000000000000",
		"0x6286b543d78ea89d50b36f694f769fbaa1dd8989": "10000000000000000000000",
	}
